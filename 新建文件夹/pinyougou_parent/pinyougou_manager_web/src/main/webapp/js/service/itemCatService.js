...
app.service('itemCatService',function($http){
	...
	// 查父类id
	this.findParentId=function(parenid){
		return $http.get('../itemCat/findParentId.do?parenid='+parenid);
	}

	// 修改参数
	this.updateById=function (id) {
		return $http.get("/itemCat/updateById.do?id="+id);
	}
	// 修改参数
	this.findNameId=function (id) {
		return $http.get("/itemCat/findNameId.do?id="+id);
	}
});
